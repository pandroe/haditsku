...
class ListNarratorMalikHadithScreen extends StatefulWidget {
  @override
  _ListNarratorMalikHadithScreenState createState() =>
      _ListNarratorMalikHadithScreenState();
}

class _ListNarratorMalikHadithScreenState
    extends State<ListNarratorMalikHadithScreen> {
  ...
  void initState() {
    ...
    _haditsModels = _loadHaditsModels(['content_of_malik']);
  }
