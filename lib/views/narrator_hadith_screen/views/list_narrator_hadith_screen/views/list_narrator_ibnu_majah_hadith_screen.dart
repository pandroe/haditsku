...
class ListNarratorIbnuMajahHadithScreen extends StatefulWidget {
  @override
  _ListNarratorIbnuMajahHadithScreenState createState() =>
      _ListNarratorIbnuMajahHadithScreenState();
}

class _ListNarratorIbnuMajahHadithScreenState
    extends State<ListNarratorIbnuMajahHadithScreen> {
  ...
  void initState() {
    ...
    _haditsModels = _loadHaditsModels(['content_of_ibnu_majah']);
  }
