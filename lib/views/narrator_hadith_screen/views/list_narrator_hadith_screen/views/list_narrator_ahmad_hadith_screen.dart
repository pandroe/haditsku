...
class ListNarratorAhmadHadithScreen extends StatefulWidget {
  @override
  _ListNarratorAhmadHadithScreenState createState() =>
      _ListNarratorAhmadHadithScreenState();
}

class _ListNarratorAhmadHadithScreenState
    extends State<ListNarratorAhmadHadithScreen> {
  ...
  void initState() {
    ...
    _haditsModels = _loadHaditsModels(['content_of_ahmad']);
  }
