...
class ListNarratorTirmidziHadithScreen extends StatefulWidget {
  @override
  _ListNarratorTirmidziHadithScreenState createState() =>
      _ListNarratorTirmidziHadithScreenState();
}

class _ListNarratorTirmidziHadithScreenState
    extends State<ListNarratorTirmidziHadithScreen> {
  ...
  void initState() {
    ...
    _haditsModels = _loadHaditsModels(['content_of_tirmidzi']);
  }
