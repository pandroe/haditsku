...
class ListNarratorDarimiHadithScreen extends StatefulWidget {
  @override
  _ListNarratorDarimiHadithScreenState createState() =>
      _ListNarratorDarimiHadithScreenState();
}

class _ListNarratorDarimiHadithScreenState
    extends State<ListNarratorDarimiHadithScreen> {
  ...
  void initState() {
    ...
    _haditsModels = _loadHaditsModels(['content_of_darimi']);
  }
