...
class ListNarratorNasaiHadithScreen extends StatefulWidget {
  @override
  _ListNarratorNasaiHadithScreenState createState() =>
      _ListNarratorNasaiHadithScreenState();
}

class _ListNarratorNasaiHadithScreenState
    extends State<ListNarratorNasaiHadithScreen> {
  ...
  void initState() {
    ...
    _haditsModels = _loadHaditsModels(['content_of_nasai']);
  }
