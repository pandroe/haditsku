...
class ListNarratorBukhariHadithScreen extends StatefulWidget {
  @override
  _ListNarratorBukhariHadithScreenState createState() =>
      _ListNarratorBukhariHadithScreenState();
}

class _ListNarratorBukhariHadithScreenState
    extends State<ListNarratorBukhariHadithScreen> {
  ...
  void initState() {
    ...
    _haditsModels = _loadHaditsModels(['content_of_bukhari']);
  }
