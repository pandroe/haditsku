...
class ListNarratorAbuDaudHadithScreen extends StatefulWidget {
  @override
  _ListNarratorAbuDaudHadithScreenState createState() =>
      _ListNarratorAbuDaudHadithScreenState();
}

class _ListNarratorAbuDaudHadithScreenState
    extends State<ListNarratorAbuDaudHadithScreen> {
  ...
  void initState() {
    ...
    _haditsModels = _loadHaditsModels(['content_of_abu_daud']);
  }
