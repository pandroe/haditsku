...
import 'package:haditsku/views/narrator_hadith_screen/views/list_narrator_hadith_screen/views/list_narrator_tirmidzi_hadith_screen.dart';

import '../../../../../utils/constant.dart';
import '../../../../search_detail_screen/views/search_detail_screen.dart';

class DetailNarratorTirmidziHadithScreen extends StatefulWidget {
  const DetailNarratorTirmidziHadithScreen({Key? key}) : super(key: key);

  @override
  State<DetailNarratorTirmidziHadithScreen> createState() =>
      _DetailNarratorTirmidziHadithScreenState();
}

class _DetailNarratorTirmidziHadithScreenState
    extends State<DetailNarratorTirmidziHadithScreen> {
  ...
  Future<void> _initData() async {
    try {
      _haditsModels = await _loadHaditsModels(['content_of_tirmidzi']);
    } catch (error) {
  ...
  Widget build(BuildContext context) {
    ...
    final allHaditsTirmidzi = [...haditsModels[0].data.hadiths];
    final List<Hadith> threeHadits = allHaditsTirmidzi.take(3).toList();
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Imam Tirmidzi - ${haditsModels[0].data.available} Hadits',
                        style: TextStyle(
                          color: Colors.black,
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                ListNarratorTirmidziHadithScreen(),
                          ));
                    },
                    child: Text(
                      'Lihat lainnya',
