...
import 'package:haditsku/views/narrator_hadith_screen/views/list_narrator_hadith_screen/views/list_narrator_darimi_hadith_screen.dart';

import '../../../../../utils/constant.dart';
import '../../../../search_detail_screen/views/search_detail_screen.dart';

class DetailNarratorDarimiHadithScreen extends StatefulWidget {
  const DetailNarratorDarimiHadithScreen({Key? key}) : super(key: key);

  @override
  State<DetailNarratorDarimiHadithScreen> createState() =>
      _DetailNarratorDarimiHadithScreenState();
}

class _DetailNarratorDarimiHadithScreenState
    extends State<DetailNarratorDarimiHadithScreen> {
  ...
  Future<void> _initData() async {
    try {
      _haditsModels = await _loadHaditsModels(['content_of_darimi']);
    } catch (error) {
  ...
  Widget build(BuildContext context) {
    ...
    final allHaditsDarimi = [...haditsModels[0].data.hadiths];
    final List<Hadith> threeHadits = allHaditsDarimi.take(3).toList();
        ...
        SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Imam Darimi - ${haditsModels[0].data.available} Hadits',
                        style: TextStyle(
                          color: Colors.black,
              ...
              SizedBox(height: constant.size.height * 0.025),
              Text(
                ''' Musnad Ahmad adalah kitab hadis yang disusun oleh Imam Ahmad bin Hanbal, seorang ulama hadis dan fikih yang hidup antara tahun 780 hingga 855 Masehi. Kitab ini memuat koleksi hadis yang disusun berdasarkan nama para perawi hadis, dan memuat sekitar 30.000 hadis yang diambil dari berbagai sumber, tetapi hadis yang di dapatkan pada aplikasi ini adalah 26.363 hadis. Kitab ini dianggap sebagai salah satu kitab hadis paling otentik dan penting dalam Islam Sunni, dan sering digunakan sebagai referensi dalam memecahkan masalah-masalah fikih. Kitab ini juga memiliki banyak syarah (komentar) yang ditulis oleh ulama lain, menunjukkan kepentingan dan otoritasnya dalam literatur hadis dan fikih Islam.''',
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                ListNarratorDarimiHadithScreen(),
                          ));
                    },
                    child: Text(
                      'Lihat lainnya',
