...
class DetailNarratorMuslimHadithScreen extends StatefulWidget {
  ...
  @override
  State<DetailNarratorMuslimHadithScreen> createState() =>
      _DetailNarratorMuslimHadithScreenState();
}

class _DetailNarratorMuslimHadithScreenState
    extends State<DetailNarratorMuslimHadithScreen> {
  ...
  Future<void> _initData() async {
    try {
      _haditsModels = await _loadHaditsModels(['content_of_muslim']);
    } catch (error) {
        ...
        SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Imam Muslim - ${haditsModels[0].data.available} Hadits',
                        style: TextStyle(
                          color: Colors.black,
              ...
              SizedBox(height: constant.size.height * 0.025),
              Text(
                ''' Shahih Muslim adalah kitab koleksi hadis yang disusun oleh Muslim bin al-Hajjaj, seorang murid dari Imam Bukhari, yang hidup antara 202 hingga 261 Hijriah. Kitab ini dikenal sebagai salah satu kitab hadis tersahih dalam Islam Sunni, dan merupakan salah satu dari dua kitab hadis paling terkenal, bersama dengan Shahih Bukhari. Kitab ini memuat sekitar 5362 hadis menurut penomoran al-Alamiyah, yang mencakup berbagai aspek kehidupan, termasuk hukum, keutamaan amal, etika pergaulan, sejarah, dan berita tentang kejadian-kejadian di masa mendatang. Shahih Muslim terbagi menjadi beberapa kitab, di mana tiap kitab terdiri dari beberapa bab yang menunjukkan pemahaman Imam Muslim terhadap hadis-hadis yang termuat di dalamnya.''',
